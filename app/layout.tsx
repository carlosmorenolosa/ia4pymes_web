...
/* ---- JSON-LD schemas (moved outside component & loaded lazyOnload) ---- */
const schemaWebSite = {
    ...
    <html lang="es" className="scroll-smooth">
      ...
      <body className={`${inter.variable} ${geistMono.variable} font-sans text-slate-900`}>
        ...
        <Script
          ...
          strategy="lazyOnload"
        />
        {/* JSON-LD schemas — cargados sin bloquear el render */}
        <Script id="schema-website" type="application/ld+json" strategy="lazyOnload"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaWebSite) }} />
        <Script id="schema-organization" type="application/ld+json" strategy="lazyOnload"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaOrganization) }} />
        <Script id="schema-local-business" type="application/ld+json" strategy="lazyOnload"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaLocalBusiness) }} />
        <Script id="schema-service" type="application/ld+json" strategy="lazyOnload"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaService) }} />
        <Script id="schema-faq" type="application/ld+json" strategy="lazyOnload"
          dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaFAQ) }} />
        <Script id="schema-breadcrumb" type="application/ld+json" strategy="lazyOnload"
