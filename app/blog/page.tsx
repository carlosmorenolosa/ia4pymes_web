...
export default function BlogPage() {
    ...
    return (
        <main className="min-h-screen bg-slate-950 text-slate-300 selection:bg-blue-500/30">
            {/* Elegant Tech Header (Dark Theme) */}
            ...
            {/* Newsletter / CTA Section (Elegant Dark Tech) */}
            <section className="py-24 relative overflow-hidden border-t border-white/5">
                <div className="absolute inset-0 bg-slate-900/30" />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg h-[400px] bg-blue-600/5 rounded-full blur-[120px]" />

                <div className="container mx-auto px-4 sm:px-6 max-w-3xl text-center relative z-10">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-slate-900 border border-white/10 mb-8 shadow-2xl">
