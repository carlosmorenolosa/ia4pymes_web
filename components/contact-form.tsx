    ...
    if (submitStatus === "success") {
        return (
            <div className="w-full max-w-2xl mx-auto my-16">
                <div className="bg-white/50 backdrop-blur-xl border border-white/20 p-8 sm:p-12 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] text-center">
