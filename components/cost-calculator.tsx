                            ...
                            >
                                ...
                                <div className="relative z-10 flex flex-col h-full justify-between">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="pt-2 flex flex-col items-center">
                                            ...
                                            <div className="relative">
                                                ...
                                                {/* Underline accent */}
                                                <div className="absolute -bottom-2 left-0 right-0 h-2 bg-red-500/20 rounded-full blur-[1px]"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-8">
                                        <Link
                                            href={t.ctaHref}
                                            className="flex items-center justify-center w-full bg-blue-600 hover:bg-blue-700 text-white font-black py-4 px-6 rounded-2xl transition-all duration-300 group shadow-[0_12px_24px_-8px_rgba(37,99,235,0.4)] hover:scale-[1.02] active:scale-[0.98]"
                                        >
                                            {t.ctaButton}
